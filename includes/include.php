...
add_action('init', array('wpshop_init', 'check_template_file'));
...
// add_action(WPSHOP_NEWTYPE_IDENTIFIER_CATEGORIES . '_add_form_fields', array('wpshop_categories', 'category_add_fields'));
