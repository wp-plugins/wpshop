...
<div class="wps-pos-order-completion-button" >
	<a href="<?php echo admin_url( 'admin.php?page=wps-pos&new_order=yes' ); ?>" class="wps-bton-first-rounded alignright" role="button"><?php _e('Create a new order', 'wps-pos-i18n'); ?></a>
