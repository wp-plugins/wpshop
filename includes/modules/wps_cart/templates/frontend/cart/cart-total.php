			...
			<div class="wps-cart-resume-alignRight">
				...
				<?php else : ?>
					<?php if( empty( $cart_content['order_status'] ) || ( $cart_content['order_status'] == 'awaiting_payment' ) ) : ?>
						<span class="wps-form-group"><span class="wps-form"><input type="text" size="5" value="<?php echo number_format( $shipping_cost_ati, 2 ); ?>" id="wps-orders-shipping-cost" class="wps-error" style="text-align : right" /></span></span>
					<?php else : ?>
