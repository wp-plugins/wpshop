...
function wpshopShowMessage(message){
	...
	wpshop("#wpshopMessage").html(message);
}
/**
...
function wpshopMainInterface(currentType, returnAlertMessage, deleteElementMessage){
	...
	wpshop("#wpshopFormManagementContainer").tabs();

	/*	Add an indicator on the page for usert alert when changing something in the page and clicking on return button	*/
	wpshop("#" + currentType + "_form input, #" + currentType + "_form textarea").keypress(function(){
		wpshop("#" + currentType + "_form_has_modification").val("yes");
	});
	wpshop("#" + currentType + "_form select").change(function(){
		wpshop("#" + currentType + "_form_has_modification").val("yes");
	});

	/*	Action when clicking on the delete button	*/
	wpshop("#delete").click(function(){
		wpshop("#" + currentType + "_action").val("delete");
		deleteElement(currentType, deleteElementMessage);
	});
	if(wpshop("#" + currentType + "_action").val() == "delete"){
		deleteElement(currentType, deleteElementMessage);
	}

	/*	Action when clicking on the save/add/saveandcontinue button	*/
	wpshop("#save, #add").click(function(){
		wpshop("#" + currentType + "_form").submit();
	});
	wpshop("#saveandcontinue").click(function(){
		wpshop("#" + currentType + "_form").attr("action", wpshop("#" + currentType + "_form").attr("action") + wpshop("#wpshopFormManagementContainer li.ui-tabs-selected a").attr("href"));
		wpshop("#" + currentType + "_action").val(wpshop("#" + currentType + "_action").val() + "andcontinue");
		wpshop("#" + currentType + "_form").submit();
	});
	...
	wpshop(".cancelButton").click(function(){
		if((wpshop("#" + currentType + "_form_has_modification").val() == "yes")){
